...
export default function FeaturedPage() {
  ...
  const featuredProducts = [
  {
    ...
    price: 1850,
    image: "https://source.unsplash.com/400x300/?floral,dress,summer",  // Imagen vestido floral verano
    category: "dresses",
    isNew: true,
    discount: 15,
    featured: true,
  },
  {
    ...
    price: 1650,
    image: "https://source.unsplash.com/400x300/?jeans,pants",  // Imagen jeans premium stretch
    category: "bottoms",
    isNew: true,
    featured: true,
  },
  {
    ...
    price: 850,
    image: "https://source.unsplash.com/400x300/?necklace,minimalist",  // Imagen collar minimalista
  ...
  },
  {
    ...
    price: 2850,
    image: "https://source.unsplash.com/400x300/?elegant,dress",  // Imagen vestido elegante
    category: "dresses",
    isNew: true,
    featured: true,
  },
  {
    ...
    price: 750,
    image: "https://source.unsplash.com/400x300/?crop-top,summer",  // Imagen top crop estampado
    category: "tops",
    isNew: true,
    featured: true,
  },
  {
    ...
    price: 550,
    image: "https://source.unsplash.com/400x300/?earrings,geometric",  // Imagen aretes geométricos
    category: "accessories",
    isNew: true,
    featured: true,
  },
  ...
  useState(() => {
    if (typeof window !== "undefined") {
      ...
      const favs = featuredProducts.filter((product) => isInFavorites(product.id)).map((p) => p.id)
      setFavorites(favs)
    }
  })
    ...
    <div className="flex min-h-screen flex-col">
      <main className="flex-1 container px-4 py-8 md:px-6 md:py-12">
        <Breadcrumb
          items={[
            { label: "Inicio", href: "/" },
            { label: "Destacados", href: "/featured", active: true },
          ]}
        />

        <div className="mt-8">
          <h1 className="text-3xl font-bold">Productos Destacados</h1>
          <p className="text-gray-500 mt-2">Descubre nuestra selección de productos más populares</p>
        </div>
